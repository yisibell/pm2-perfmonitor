const defaultOptions = {
   ...
   */
  zombieProcessDetectionStrategy: 'zero-cpu-consecutive',
  ...
  /**
   * 是否开启 node:inspector 性能采集（CPU 过载时）
   */
  enableNodeInspectorOnCpuOverload: false,

  /**
   * 是否在检测到僵尸进程时，重启前采集诊断数据
   * （CPU profile + active handles/requests dump）
   */
  enableNodeInspectorOnZombie: false,
